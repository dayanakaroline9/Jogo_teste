...
function preload() {
  img1 = loadImage('fusao.jpg');
  img2 = loadImage('prof.jpeg');
  img3 = loadImage('day.jpg');
  fundo = loadImage('fundo.png');
  fundo2 = loadImage('ceu.png');
  voltar = loadImage('voltar.png');
  prox = loadImage('prox.png');
  play = loadImage('play.png');
  menu = loadImage('menu.png');
  faseImg[0] = loadImage('1.png');
  faseImg[1] = loadImage('2.png');
  faseImg[2] = loadImage('3.png');
  faseImg[3] = loadImage('4.png');
  faseImg[4] = loadImage('5.png');
  faseImg[5] = loadImage('6.png');
  faseImg[6] = loadImage('7.png');
  faseImg[7] = loadImage('8.png');
  faseImg[8] = loadImage('9.png');
  feliz = loadImage('feliz.png');
  triste = loadImage('triste.png');
  quest[0] = loadImage('q1.jpg'); //agua
  quest[1] = loadImage('q2.jpg'); //gasoso ou evaporação
  quest[2] = loadImage('sorvete.jpg'); //sorvete
  quest[3] = loadImage('q5.jpg'); //gelo derretendo
  quest[4] = loadImage('q6.jpg'); //gelo solido na forma
  quest[5] = loadImage('q7.jpg'); //agua fervendo
  quest[6] = loadImage('nivel8.jpg'); //Ovo cozido
  quest[7] = loadImage('q9.png'); // tirinha cascão
  quest[8] = loadImage('q10.jpg'); // tirinha turma da monica
  quest[9] = loadImage('q13.jpg'); // tirinha monica granizo
  quest[10] = loadImage('q14.jpg'); // gelo seco
  quest[11] = loadImage('1-1.png'); //tirinha img 1
  quest[12] = loadImage('2-1.png'); //tirinha img 2
  quest[13] = loadImage('3-1.png'); // tirinha img 3
}

function setup() {
  createCanvas(600, 600);
  //audio = createAudio('assets/beat.mp3');
}
...
function draw() {
  ...
  if (tela == 1) {
    ...
    //Botão da tela de fases do jogo
    ...
    //Botão de Créditos
    else if ((mouseIsPressed) && (mouseX > xBt3 && mouseX < xBt3 + largBt3) && (mouseY > yBt3 && mouseY < yBt3 + altura)) {
      tela = 4;
    }
  ...
  //fase 8
    ...
    noStroke();
    fill(20);
    text("Reversível", pergBotX, pergBotY2 + 10, largBot, altBot);
    ...
    noStroke();
    fill(20);
    text("Irreversível", pergBotX, pergBotY3 + 10, largBot, altBot);
  ...
  //Final do Jogo
    ...
    stroke(corBot);
    fill("#eff1f1");
    square(iconMx + 50, iconMy, iconTam, 5);
    image(menu, iconMx + 52, iconMy + 2, iconTam - 4, 37);

    //icone play
    stroke(corBot);
    fill("#eff1f1");
    square(iconPx + 50, iconPy, iconTam, 5);
    image(voltar, iconPx + 52, iconPy + 2, iconTam - 4, 37);

    //BOTÃO MENU
    if ((mouseIsPressed) && (mouseX >= iconMx && mouseX <= iconMx + iconTam) && (mouseY >= iconMy && mouseY <= iconMy + iconTam)) {
      tela = 1;
    }
    //BOTÃO VOLTAR
    else if ((mouseIsPressed) && (mouseX >= iconVx && mouseX <= iconVx + iconTam) && (mouseY >= iconVy && mouseY <= iconVy + iconTam)) {
      tela = 2;
    }
